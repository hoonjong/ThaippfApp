package com.cookandroid.registerloginexample.httpUtil;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    @Override
    protected void onCreate(Bundle savedInstanceState) { //액티비티 처음 시작시 실행되는 생명주기!
